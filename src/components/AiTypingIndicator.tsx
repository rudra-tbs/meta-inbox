...
export default function AiTypingIndicator() {
  return (
    <div className="flex justify-end mb-2" aria-live="polite">
      <div className="bg-muted/60 rounded-lg rounded-tr-sm px-3 py-2 inline-flex items-center gap-2">
        <span className="text-text-secondary text-sm" aria-hidden>✨</span>
